...
CREATE POLICY "stores_business_isolation" ON stores
  FOR ALL USING (true);
...
CREATE POLICY "unit_categories_business_isolation" ON unit_categories
  FOR ALL USING (true);
...
CREATE TABLE IF NOT EXISTS products (
  ...
  sale_mode TEXT NOT NULL DEFAULT 'UNIT' CHECK (sale_mode IN ('UNIT', 'VARIABLE')),
  photo_uri TEXT,
...
CREATE POLICY "tickets_business_isolation" ON tickets
  FOR ALL USING (true);
...
CREATE POLICY "ticket_items_business_isolation" ON ticket_items
  FOR ALL USING (true);
...
CREATE POLICY "purchases_business_isolation" ON purchases
  FOR ALL USING (true);
...
CREATE POLICY "purchase_items_business_isolation" ON purchase_items
  FOR ALL USING (true);
...
CREATE POLICY "expenses_business_isolation" ON expenses
  FOR ALL USING (true);
